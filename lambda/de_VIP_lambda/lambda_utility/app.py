...
from tracking.yolov8n.detect import DetectYolov8n
import cv2
import base64
...
class Inference:
    def __init__(self) -> None:
        ...
        self.detect_obj = DetectYolov8n(self.yolov8n_model)
...
def lambda_handler(event, context):
    ...
    try:
        ...
        outs = inference_obj.detect_obj.detect(frames,dist=True)
        # print(type(outs))
        inf_time = time.time() - start

        inference_obj.logger.info(f"output of distance estimation vip: {outs}")
