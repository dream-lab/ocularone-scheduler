...
class Inference:
    def __init__(self) -> None:
        ...
        self.logger = create_logger('MD','MD')
        # print(f"HVT loaded in {time.time() - start}")
        #self.logger.info(f"MD loaded in {time.time() - start}")
...
def lambda_handler(event, context):
    ...
    try:
        ...
        outs = inference_obj.detect_mask.inference(frames, draw_result = False, show_result = False, target_shape = (360, 360))
        # print(type(outs))
